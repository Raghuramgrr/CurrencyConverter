...
public class exchangerateController {
	...
	/**
	 * REST controller can take Date and currencies as input and gives exchange rate
	 * as output.
	 *
	 * Sample -
	 * 
	 * http://ec2-**-**-98-69.compute-1.amazonaws.com:8080/converter/exchange?text=2017-01-01
	 * SGD EUR Supports only 8 currencies
	 * 
	...
	private boolean supportedCurrCheck(String sCurr) {
		...
		if (!(sCurr.equalsIgnoreCase("BHD") || sCurr.equalsIgnoreCase("CHF") || sCurr.equalsIgnoreCase("EUR")
				|| sCurr.equalsIgnoreCase("GBP") || sCurr.equalsIgnoreCase("KWD") || sCurr.equalsIgnoreCase("OMR")
				|| sCurr.equalsIgnoreCase("USD") || sCurr.equals("SGD"))) {
			return false;
		} else
			return true;
